import Login from '@/components/Login_mobile';

const Callout = () => {
  return (
    <div
      className='my-8 flex rounded-3xl p-6 bg-amber-50 dark:bg-slate-800/60 dark:ring-1 dark:ring-slate-300/10 max-w-2xl
    l'
    >
      <svg
        aria-hidden='true'
      ...
      <div className='ml-4 flex-auto'>
        ...
        <div
          className='
        prose mt-2.5 text-amber-800 [--tw-prose-underline:theme(colors.amber.400)] [--tw-prose-background:theme(colors.amber.50)]
        prose-a:text-amber-900 prose-code:text-amber-900 dark:text-slate-300 dark:[--tw-prose-underline:theme(colors.sky.700)] dark:prose-code:text-slate-300
        pr-2 sm:pr-12'
        >
          <p>
            While the data used for this research is not sensitive and was made
            public on social platforms, we are keeping a discreet approach in
            that only authorized users can access. If you are interested in
            collaborating or reviewing the data and our methods, you may contact
            us and ask for credentials.
          </p>
        </div>
